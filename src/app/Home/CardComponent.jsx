          ...
          {courses.map((course, index) => (
            ...
            >
              {course.isBestSelling && (
                <div className="absolute flex items-center space-x-1 shadow-lg shadow-[#708090] dark:shadow-[#003b6d] top-3 left-3 bg-gradient-to-r from-[#ff9a3f] to-[#ffc13f] text-white py-1 px-3 rounded-full z-10">
